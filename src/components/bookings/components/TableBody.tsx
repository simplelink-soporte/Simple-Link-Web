...
import { Selection, SelectionState, SelectedBooking } from "@/types/bookings"
import { BookingBlock } from "./BookingBlock/BookingBlock"
import { ClassBlock } from "./BookingBlock/ClassBlock"
import { Z_LAYERS } from "@/constants/zIndex"
import { TransformedClass, isTransformedClass } from "@/types/classes"
...
interface TableBodyProps {
  ...
  isMouseDown: boolean
  isDragging: boolean
  getExistingBooking: (courtId: string, time: string) => (TransformedClass | SelectedBooking | null)
