...
import { Copy, HelpCircle, Link, Settings, PlusCircle, ExternalLink, CalendarPlus } from "lucide-react";
          ...
          <div className="flex items-center justify-center h-20 rounded-md bg-gray-50 border border-dashed border-gray-200">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-xs text-gray-500">
                {isUpdatingSlug ? "Actualizando..." : "Cargando..."}
              </p>
            </div>
          </div>
        ) : linkData ? (
