...
interface SelectionSummaryToastProps {
...
/**
 * Componente de notificación que muestra un resumen de los ítems seleccionados
 * Se muestra en la parte inferior de la pantalla con animaciones suaves
 */
export const SelectionSummaryToast: React.FC<SelectionSummaryToastProps> = ({ 
  selectedItems, 
  getItemDetails,
  theme,
  visible
