...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[40] flex flex-col p-4 gap-2 w-full max-w-[420px] mb-4 mr-4",
      className
    )}
    {...props}
  />
