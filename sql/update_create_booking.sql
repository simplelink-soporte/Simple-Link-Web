-- Script para actualizar la función create_booking_v2
-- Fecha: 27/12/2023

-- 1. Recrear la función con manejo mejorado de tipos de enumeración
...
BEGIN
    ...
    -- Manejar la conversión del método de pago
    v_payment_method := CASE 
        WHEN p_payment_method::text = 'card' THEN 'stripe'::payment_method_enum
        ...
        BEGIN
            ...
            LOOP
                ...
                IF NOT EXISTS (
                    ...
                    RAISE EXCEPTION 'El participante con ID % no existe', (v_participant->>'member_id');
                END IF;
