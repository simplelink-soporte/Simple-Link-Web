-- Script para corregir todas las referencias a rental_start_time
-- Primero, desactivar todos los triggers que puedan interferir
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'prevent_item_overlap'
    ) THEN
        ALTER TABLE booking_rentals
