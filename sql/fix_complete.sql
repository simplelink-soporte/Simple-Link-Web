...
BEGIN
    ...
    -- Crear tipos con valores correctos
...
-- 2. Recrear la tabla trigger_logs si no existe
...
-- 3. Recrear el procedimiento almacenado con mejor manejo de errores
